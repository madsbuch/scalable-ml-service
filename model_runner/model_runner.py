import torch
from architecture import EncoderRNN, AttnDecoderRNN 
import unicodedata
import re
import pickle
...
# Class used to pickle deserialize
class Lang:
...
input_lang = None
output_lang = None
with open('./input_lang.bin', 'rb') as f:
    input_lang = pickle.load(f)
with open('./output_lang.bin', 'rb') as f:
...
def translateSentence(input_sentence):
    try:
        sentence = normalizeString(input_sentence)
        output_words, attentions = evaluate(enc, dec, sentence)
